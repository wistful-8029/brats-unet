...
# train
train_set = {
    'root': '/mnt/sda3/yigedabuliu/lkq/data/Task01_BrainTumour/',  # 四个模态数据所在地址
    'out': '/mnt/sda3/yigedabuliu/lkq/data/Task01_BrainTumour_h5/',  # 预处理输出地址
    'flist': '/mnt/sda3/yigedabuliu/lkq/data/train.txt',  # 训练集名单（有标签）
}
